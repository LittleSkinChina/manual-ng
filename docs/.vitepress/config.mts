          ...
          items: [
                  ...
                  items: [
                    {
                      ...
                      link: "/yggdrasil/authlib-injector",
                    },
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: "OAuth for Yggdrasil",
                  link: "/feature/oauth-for-yggdrasil",
                },
              ],
            },
          ],
          ...
          items: [
            {
              ...
              items: [
                {
                  text: "授权代码流",
                  link: "/advanced/oauth2/authorization-code-grant",
                },
                {
                  text: "设备代码流",
                  link: "/advanced/oauth2/device-authorization-grant",
                },
              ],
            },
            { text: "LittleSkin API", link: "/advanced/api" },
            { text: "Yggdrasil Connect", link: "/advanced/yggdrasil-connect/",
              collapsed: true,
              items: [  
                { text: "启动器实现规范", link: "/advanced/yggdrasil-connect/launcher" },
              ]
             },
          ],
        },
