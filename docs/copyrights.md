...
请在下列情形中选择最合适的情形，并准备相应的原创证明材料：<small>（点击卡片标题可展开卡片内容）</small>
...
使用 <mark>你的 LittleSkin 账号绑定的邮箱</mark> 向我们发送 [邮件工单](./email.md)，说明你想要为你上传的材质申请「版权保护标记」，并附上上述原创证明材料以及要申请「版权保护标记」的材质在 LittleSkin 的 TID。
